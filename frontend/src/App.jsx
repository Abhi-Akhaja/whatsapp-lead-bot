    ...
    return (
        <div className="app-shell">
            <Sidebar
                ...
                doneCount={leads.filter((l) => l.current_step === "done").length}
            />
            <LeadList leads={leads} selectedId={selectedLead} onSelect={setSelectedLead} />
            <ConversationPanel lead={currentLead} messages={messages} onSend={handleSend} />
        </div>
    );
}
